...
# Этот бот находится в состоянии "мне все равно"
Новые функции и фиксы после "ломающих" изменений
будут реализованы только при большом спросе,
и то это не гарантировано.
...
#### Небольшая забавная заметочка
- Я осознаю хуёвость этого кода
- Мне абсолютно поебать
- Не хочу больше с этим ебаться (но приходится)
