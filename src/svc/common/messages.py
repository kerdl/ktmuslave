...
ZOOM_DATA_FORMAT = (
    "📝 | Формат:\n"
    "   ↵ имя: <Фамилия> <Имя> <Отчество> [ИЛИ] <Фамилия> <И>.<О>.\n"
    "   ↵ ссылка: <Ссылка>\n"
    "   ↵ ид: <ID>\n"
    "   ↵ код: <Код>\n"
    "   ↵ заметки: <Любой текст, например твой фанфик или ссыль на фурри порно>\n"
    "   ↵ ..."
)
...
ENTER_NOTES = (
    ...
    "   ╰ 👉 Например: твой фанфик или ссыль на фурри порно и т.д."
)
